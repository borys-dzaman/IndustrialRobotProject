...
namespace IndustrialRobot.Models
{
    public class DataAccess
    {
        ...
        string[] streetAddresses = new string[] { "101 State Street", "425 Oak Avenue", "7 Wallace Way", "928 Edwars Court", "29 Main Avenue" };
        string[] cities = new string[] { "Springfield", "Wilshire", "Alexandria", "Franklin", "Clinton", "Fairview", "Madison" };
        string[] states = new string[] { "WI", "GA", "PA", "TX", "CA", "IL", "WA", "FL", "OK", "AZ" };
